"""
Year2 Part 1 - OPTIMIZED Compact Layout Generator

Machine counts for Year2 Part 1:
...
AREAS = {
    "B1": {"group": "ABCD", "count": 14, "rows": 7, "cols": 2, "eff_w":  26, "eff_h": 86},
    "A": {"group": "ABCD", "count":  6, "rows": 6, "cols": 1, "eff_w":  14, "eff_h": 74},
    "B2": {"group": "ABCD", "count": 14, "rows": 7, "cols": 2, "eff_w":  26, "eff_h": 86},
    "C": {"group": "ABCD", "count":  3, "rows": 3, "cols": 1, "eff_w":  14, "eff_h": 38},
    "D": {"group": "ABCD", "count": 14, "rows": 7, "cols": 2, "eff_w":  26, "eff_h": 86},
    "I": {"group": "HIJ", "count":  7, "rows": 7, "cols": 1, "eff_w":  36, "eff_h": 98},
    "J": {"group": "HIJ", "count": 14, "rows": 7, "cols": 2, "eff_w":  72, "eff_h": 98},
}
...
def generate_layout():
    ...
    ax.set_aspect('equal')
    ax.set_title(f'Year2 Layout - {sum([AREAS[p]["count"] for p in PROCESS_ORDER])} Machines Total', 
