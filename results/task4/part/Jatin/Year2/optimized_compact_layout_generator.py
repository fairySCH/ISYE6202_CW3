...
# Year 2: 83 machines total (with 88.2% effective availability)
AREAS = {
...
def generate_layout():
    ...
    ax.set_aspect('equal')
    ax.set_title(f'Year2 Layout - {sum([AREAS[p]["count"] for p in PROCESS_ORDER])} Machines Total (88.2% Effective Availability)', 
