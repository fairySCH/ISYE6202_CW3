"""
Year 2 Part 1 - Optimized Layout Generator with Overlap Visualization

Machine counts for Year 2 Part 1:
- B1: 14, A: 6, B2: 14, C: 3, D: 14, I: 7, J: 14
- Total: 72 machines
"""
...
# Area data - Year 2 actual machine counts and grid configurations
AREAS = {
    "B1": {"group": "ABCD", "count": 14, "rows": 5, "cols": 3, "eff_w": 38, "eff_h": 62},
    "A":  {"group": "ABCD", "count": 6,  "rows": 6, "cols": 1, "eff_w": 14, "eff_h": 74},
    "B2": {"group": "ABCD", "count": 14, "rows": 5, "cols": 3, "eff_w": 38, "eff_h": 62},
    "C":  {"group": "ABCD", "count": 3,  "rows": 3, "cols": 1, "eff_w": 14, "eff_h": 38},
    "D":  {"group": "ABCD", "count": 14, "rows": 5, "cols": 3, "eff_w": 38, "eff_h": 62},
    "I":  {"group": "HIJ",  "count": 7,  "rows": 2, "cols": 4, "eff_w": 56, "eff_h": 72},
    "J":  {"group": "HIJ",  "count": 14, "rows": 3, "cols": 5, "eff_w": 70, "eff_h": 108},
}
...
def create_layout_diagram():
    ...
    print("Creating Year 2 Part 1 layout...")
    print("  Year 2 actual: 72 machines")
    ...
    ax.set_title(f'Year 2 Part 1 Layout: {layout["width"]:.0f} ft × {layout["height"]:.0f} ft\n72 machines total', 
