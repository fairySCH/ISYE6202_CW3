"""
Year3 Part 1 - OPTIMIZED Compact Layout Generator

Machine counts for Year3 Part 1:
...
# Year 3: 88 machines total (with 88.2% effective availability)
AREAS = {
    "B1": {"group": "ABCD", "count": 17, "rows": 9, "cols": 2, "eff_w":  26, "eff_h": 110},
    "A":  {"group": "ABCD", "count":  7, "rows": 7, "cols": 1, "eff_w":  14, "eff_h":  86},
    "B2": {"group": "ABCD", "count": 17, "rows": 9, "cols": 2, "eff_w":  26, "eff_h": 110},
    "C":  {"group": "ABCD", "count":  4, "rows": 4, "cols": 1, "eff_w":  14, "eff_h":  50},
    "D":  {"group": "ABCD", "count": 17, "rows": 9, "cols": 2, "eff_w":  26, "eff_h": 110},
    "I":  {"group": "HIJ",  "count":  9, "rows": 9, "cols": 1, "eff_w":  36, "eff_h": 126},
    "J":  {"group": "HIJ",  "count": 17, "rows": 9, "cols": 2, "eff_w":  72, "eff_h": 126},
}
...
def generate_layout():
    ...
    ax.set_aspect('equal')
    ax.set_title(f'Year3 Layout - {sum([AREAS[p]["count"] for p in PROCESS_ORDER])} Machines Total (88.2% Effective Availability)', 
