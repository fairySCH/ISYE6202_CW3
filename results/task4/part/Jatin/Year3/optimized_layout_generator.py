"""
Year 3 Part 1 - Optimized Layout Generator with Overlap Visualization

Machine counts for Year 3 Part 1:
- B1: 14, A: 6, B2: 15, C: 3, D: 15, I: 8, J: 15
- Total: 76 machines
"""
...
# Area data - Year 3 actual machine counts and grid configurations
AREAS = {
...
def create_layout_diagram():
    ...
    print("Creating Year 3 Part 1 layout...")
    print("  Year 3 actual: 76 machines")
    ...
    ax.set_title(f'Year 3 Part 1 Layout: {layout["width"]:.0f} ft × {layout["height"]:.0f} ft\n76 machines total', 
