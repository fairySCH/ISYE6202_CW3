...
AREAS = {
    "B1": {"group": "ABCD", "count": 15, "rows": 8, "cols": 2, "eff_w":  26, "eff_h": 98},
    "A": {"group": "ABCD", "count":  6, "rows": 6, "cols": 1, "eff_w":  14, "eff_h": 74},
    "B2": {"group": "ABCD", "count": 15, "rows": 8, "cols": 2, "eff_w":  26, "eff_h": 98},
    "C": {"group": "ABCD", "count":  3, "rows": 3, "cols": 1, "eff_w":  14, "eff_h": 38},
    "D": {"group": "ABCD", "count": 15, "rows": 8, "cols": 2, "eff_w":  26, "eff_h": 98},
    "I": {"group": "HIJ", "count":  8, "rows": 8, "cols": 1, "eff_w":  36, "eff_h": 112},
    "J": {"group": "HIJ", "count": 15, "rows": 8, "cols": 2, "eff_w":  72, "eff_h": 112},
}
...
def generate_layout():
    ...
    ax.set_aspect('equal')
    ax.set_title(f'Year4 Layout - {sum([AREAS[p]["count"] for p in PROCESS_ORDER])} Machines Total', 
