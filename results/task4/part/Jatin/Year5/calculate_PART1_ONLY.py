"""
Year5 PART 1 ONLY - Machine Requirements (2 Shifts)
This calculates ONLY for P1 (29,800 units/week), not all parts!
...
# Constants
DEMAND_P1 = 29800  # units per week
...
def calculate_machines():
    print("YEAR5 PART 1 ONLY - MACHINE REQUIREMENTS (2 SHIFTS)")
    print("=" * 70)
