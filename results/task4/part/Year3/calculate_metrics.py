"""
Calculate key metrics for Year 3 Part 1 Layout:
- Distance per trip
- Net utilization
- Cost of equipment
- Total Area
...
# Machine data for Year 3 Part 1
AREAS = {
...
# Year 3 demand: 27,300 units/week for Part 1
DEMAND_YEAR3 = 27300
AVAILABLE_TIME_PER_MACHINE = 4800  # minutes per week (2-shift operation)

print("="*70)
print("YEAR 3 PART 1 - KEY METRICS CALCULATION")
print("="*70)
...
print(f"\n  Demand: {DEMAND_YEAR3:,} units/week")
...
for step, time_per_unit in P1_PROCESS_TIMES.items():
    if step in AREAS:
        ...
        total_time_needed = DEMAND_YEAR3 * time_per_unit
...
summary_path = Path(r"c:\Users\jatin\OneDrive\Desktop\Georgia Tech\Coursework\6202 Benoit\Case Work\Case Study 3\ISYE6202_CW3\results\task4\part\Jatin\Year3\Optimized_Layout_Summary.csv")
...
# ============================================================================
print("\n" + "="*70)
print("SUMMARY - YEAR 3 PART 1 METRICS")
print("="*70)
