"""
Year4 Part 1 - OPTIMIZED Compact Layout Generator

Machine counts for Year4 Part 1:
...
# Year 4: 88 machines total (with 88.2% effective availability)
AREAS = {
...
def generate_layout():
    ...
    ax.set_aspect('equal')
    ax.set_title(f'Year4 Layout - {sum([AREAS[p]["count"] for p in PROCESS_ORDER])} Machines Total (88.2% Effective Availability)', 
