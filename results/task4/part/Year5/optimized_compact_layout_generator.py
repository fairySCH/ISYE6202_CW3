...
# Year 5: 93 machines total (with 88.2% effective availability)
AREAS = {
    "B1": {"group": "ABCD", "count": 18, "rows": 9, "cols": 2, "eff_w":  26, "eff_h": 110},
    "A":  {"group": "ABCD", "count":  8, "rows": 8, "cols": 1, "eff_w":  14, "eff_h":  98},
    "B2": {"group": "ABCD", "count": 18, "rows": 9, "cols": 2, "eff_w":  26, "eff_h": 110},
    "C":  {"group": "ABCD", "count":  4, "rows": 4, "cols": 1, "eff_w":  14, "eff_h":  50},
    "D":  {"group": "ABCD", "count": 18, "rows": 9, "cols": 2, "eff_w":  26, "eff_h": 110},
    "I":  {"group": "HIJ",  "count":  9, "rows": 9, "cols": 1, "eff_w":  36, "eff_h": 126},
    "J":  {"group": "HIJ",  "count": 18, "rows": 9, "cols": 2, "eff_w":  72, "eff_h": 126},
}
...
def generate_layout():
    ...
    ax.set_aspect('equal')
    ax.set_title(f'Year5 Layout - {sum([AREAS[p]["count"] for p in PROCESS_ORDER])} Machines Total (88.2% Effective Availability)', 
