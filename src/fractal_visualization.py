...
LAYOUT_DIR = RESULTS_DIR / "fractal_layouts"
VIZ_DIR = RESULTS_DIR / "fractal_visualizations"
...
def create_flow_matrix_heatmap(num_fractals=3):
    ...
    flow_file = RESULTS_DIR / "fractal_flow_matrices" / f"f{num_fractals}_centers" / "Single_Center_Flow_Matrix.csv"
