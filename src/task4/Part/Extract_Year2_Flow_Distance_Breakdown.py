"""
Extract Flow Distance Breakdown for Year 2
Creates a CSV with step-by-step distance details for all parts in Year 2
"""
...
report_path = r"c:\Users\jatin\OneDrive\Desktop\Georgia Tech\Coursework\6202 Benoit\Case Work\Case Study 3\ISYE6202_CW3\results\task4\part\capacity\Part_Based_Year2_All_Parts_Detailed_Report.txt"
...
# Save to CSV
output_path = r"c:\Users\jatin\OneDrive\Desktop\Georgia Tech\Coursework\6202 Benoit\Case Work\Case Study 3\ISYE6202_CW3\results\task4\part\capacity\Part_Based_Year2_All_Parts_Flow_Distance_Breakdown.csv"
df.to_csv(output_path, index=False)

print("="*80)
print("FLOW DISTANCE BREAKDOWN CSV CREATED - YEAR 2")
print("="*80)
print(f"\nOutput file: Part_Based_Year2_All_Parts_Flow_Distance_Breakdown.csv")
print(f"\nTotal rows: {len(df)}")
...
if len(df) > 0:
    ...
    # Display sample
    print("\n" + "="*80)
    print("SAMPLE DATA - Part P1 (Year 2):")
    print("="*80)
    ...
    print("\n" + "="*80)
    print("SAMPLE DATA - Part P19 (Year 2 - high demand KLM part):")
    print("="*80)
    p19_data = df[df['Part'] == 'P19']
    if len(p19_data) > 0:
        print(p19_data.to_string(index=False))
    
    print("\n" + "="*80)
    print("SUMMARY BY PART (Year 2):")
    print("="*80)
